...
import org.xtext.example.mydsl.generator.StateMachineGenerator;
import org.xtext.example.mydsl.parser.antlr.StateMachineAntlrTokenFileProvider;
import org.xtext.example.mydsl.parser.antlr.StateMachineParser;
import org.xtext.example.mydsl.parser.antlr.internal.InternalStateMachineLexer;
import org.xtext.example.mydsl.scoping.StateMachineScopeProvider;
import org.xtext.example.mydsl.serializer.StateMachineSemanticSequencer;
import org.xtext.example.mydsl.serializer.StateMachineSyntacticSequencer;
import org.xtext.example.mydsl.services.StateMachineGrammarAccess;
import org.xtext.example.mydsl.validation.StateMachineConfigurableIssueCodesProvider;
import org.xtext.example.mydsl.validation.StateMachineValidator;
...
public abstract class AbstractStateMachineRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/mydsl/StateMachine.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.mydsl.StateMachine");
	}
